...
PaceLine Local is designed to keep imported training data on the user's computer. Activity payloads are encrypted in the local SQLite store with a locally generated key. The project does not include telemetry or cloud synchronisation.
